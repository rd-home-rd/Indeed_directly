...
profile.set_preference('browser.download.dir', 'C:\\Users\\seisaku\\Desktop\\Indeed')
profile.set_preference('browser.helperApps.neverAsk.saveToDisk', 'text/csv')
driver = webdriver.Firefox(profile)
wait=WebDriverWait(driver,20)
alljobarray=[]
for pagenum in range((worker_number-1)*200,worker_number*200,10):
...
writer = pandas.ExcelWriter('結果'+str(worker_number)+'.xlsx',engine="xlsxwriter")
